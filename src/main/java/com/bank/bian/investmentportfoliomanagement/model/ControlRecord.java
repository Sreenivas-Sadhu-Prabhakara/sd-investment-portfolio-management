package com.bank.bian.investmentportfoliomanagement.model;
...
/**
 * The BIAN control record for this service domain: "Investment Portfolio Management Plan".
 *
 ...
 * to its asset type (Investment Portfolio). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Investment Portfolio Management Plan";
